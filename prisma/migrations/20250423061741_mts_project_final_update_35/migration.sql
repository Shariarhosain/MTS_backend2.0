/*
  ...
  - You are about to drop the `project_master` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE "project_master" DROP CONSTRAINT "project_master_department_id_fkey";

-- DropForeignKey
ALTER TABLE "project_master" DROP CONSTRAINT "project_master_ordered_by_fkey";

-- DropForeignKey
ALTER TABLE "project_master" DROP CONSTRAINT "project_master_profile_id_fkey";

-- DropForeignKey
ALTER TABLE "project_master" DROP CONSTRAINT "project_master_team_id_fkey";
